...
function PhotoModalContent({ isOpen, onRequestClose, handlePrevImage, handleNextImage, currentImageIndex, photos }) {



  return (
    <Modal className={'photomodalcontent'} isOpen={isOpen} onRequestClose={onRequestClose}>
